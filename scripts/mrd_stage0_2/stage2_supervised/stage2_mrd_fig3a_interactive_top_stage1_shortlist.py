...
def main() -> None:
    ...
    reg_data = build_regularization_data(
...
def build_regularization_data(
    *,
    ...
    data: dict[str, Any] = {
        "discovery_metrics": _read_optional_stage2_table(discovery_scorecard),
        "lopo_metrics": _read_optional_stage2_table(lopo_scorecard),
        "lopo_by_patient": _read_optional_stage2_table(lopo_by_patient),
        "patient_specific_metrics": _read_optional_stage2_table(patient_specific_scorecard),
        "discovery_coef": _read_optional_stage2_table(discovery_coefficients),
        "lopo_coef": _read_optional_stage2_table(lopo_coefficients),
        "patient_specific_coef": _read_optional_stage2_table(patient_specific_coefficients),
...
def build_app(
    ...
    *,
    ...
    patient_options = patient_options_for_path_scope(reg_data, "cross_patient")
    initial_patient = patient_options[0]["value"] if patient_options else None
